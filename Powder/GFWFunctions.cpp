...
int AddColorAlpha (int hexInput, int shadowColor, float shadowAlpha) {
...
// inverts the given color and returns the hex value
int InvertColor (int hexInput) {
    RGB rgbInput = ConvertColor (hexInput);
    RGB rgbOutput;
    rgbOutput.r = 1.0 - rgbInput.r;
    rgbOutput.g = 1.0 - rgbInput.g;
    rgbOutput.b = 1.0 - rgbInput.b;
    int hexOutput = ConvertColor (rgbOutput);
    return hexOutput;
}
